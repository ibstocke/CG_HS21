...
function setUpObjects(){
    "use strict";
    objects.cubes.push(new WireFrameCube(gl, 1, [0,0,0],1|2,"cow.png"))
    objects.cubes.push(new WireFrameCube(gl, 0.5, [1,1,0],1))
    objects.cubes.push(new WireFrameCube(gl, 0.5, [1.55,1,0],1))
    objects.cubes.push(new WireFrameCube(gl, 1, [-1.5,-1.5,0],2))
    objects.cubes.push(new WireFrameCube(gl, 0.7, [1.5,-1.3,0],4))
